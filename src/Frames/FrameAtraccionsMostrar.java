...
public class FrameAtraccionsMostrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Univeylandia Parc - Atraccions - Mostrar");

        jLabel1.setFont(new java.awt.Font("Cantarell", 1, 24)); // NOI18N
        jLabel1.setText("Atraccions - Mostrar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameAtraccionsMostrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameAtraccionsMostrar().setVisible(true);
            }
        });
    }
