...
private void createTable() {
        ...
        ArrayList<Incidencia> incidentList = MetodesIncidencia.getList();

        for (Incidencia inc2 : incidentList) {

            listIncident[0] = inc2.getId();
            listIncident[1] = inc2.getTitle();
            listIncident[2] = inc2.getDescript();
            listIncident[3] = inc2.getNom_prioritat();
            listIncident[4] = inc2.getNom_estat();
