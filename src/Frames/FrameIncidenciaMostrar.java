 ...
 * @author alumne
 */
public class FrameIncidenciaMostrar extends javax.swing.JFrame {

    /**
     * Creates new form FrameAtraccionsInserir
     */
    public FrameIncidenciaMostrar() {
        initComponents();
        carregarGUI();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameIncidenciaMostrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameIncidenciaMostrar().setVisible(true);
            }
        });
    }
