...
private static String querySelect = "SELECT nom, cognom1, numero_document, telefon FROM users WHERE id_rol = 1;";
private static String queryMostrar = "SELECT * FROM users WHERE numero_document = ? ;";
 ...
 /* ************************************** Mètodes accessors a les sentencies SQL ************************************** */
    ...
    public static String getQueryMostrar() {
        return queryMostrar;
    }
